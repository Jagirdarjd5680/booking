...
import { LayoutDashboard, Users, LogOut, Crown, ChevronRight, Calendar } from 'lucide-react';
...
export default function Sidebar({ onLogout }) {
  ...
  return (
    <div className="w-64 bg-primary min-h-screen flex flex-col border-r border-white/10 sticky top-0 overflow-hidden">
